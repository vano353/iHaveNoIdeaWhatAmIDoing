 ...
 */
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double = ((sagenes*3+arshins)*48+vershoks)*4.445
 ...
 */
fun angleInRadian(grad: Int, min: Int, sec: Int): Double = ((grad+min/60+sec/(60*60))/180)* PI
...
fun accountInThreeYears(initial: Int, percent: Int): Double {
    fun ap(initial: Double,percent: Int) = initial + (initial*percent)/100
    return ap(ap(ap(initial.toDouble(),percent),percent),percent)
}
